...
const { mockLectureRoomUpdate, injectedMockLectureRoomData } = require("../testing/mockData");
...
describe("lecturerooms-put", () => {
  ...
  it("lecturerooms-put should update an lecture room and return the updated lecture room", async () => {
    ...
    expect(context.res.body._id.toString()).toBe(injectedLectureRoomId.toString());
    ...
    expect(context.res.body.startTime.toString()).toBe(mockLectureRoomUpdate.startTime.toString());
    expect(context.res.body.endTime.toString()).toBe(mockLectureRoomUpdate.endTime.toString());
    expect(context.res.body.firstSlideUrl).toBe(mockLectureRoomUpdate.firstSlideUrl);
